...
class WorldModel(object):
    ...
    def _build_architecture(self):
        ...
        for idx in range(self.mlp_hidden_layer_size):
            ...
            mlp_in = BatchNormalization()(mlp_in)
            mlp = Dense(units=self.mlp_layer_num_units, activation="tanh")(mlp_in)
            mlp_output = Dense(units=self.mlp_output_layer_size, activation="tanh")(mlp)
    ...
    def train_network(self, epochs=10, batch_size=256):
        ...
        fp = self.state_estimation_data_path + "/" + "models" + "/weights.{epoch:02d}-{" + metric + ":.2f}.hdf5"
