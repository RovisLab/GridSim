...
class DqnSimulator(Simulator):
    ...
    def get_sensor_reward(self, car):
        ...
        distances = self.enable_sensor(car, self.object_mask, self.screen, rays_nr=self.rays_nr)
    ...
    def step(self, action, car, dt):
        ...
        car.update(dt)
        self.draw_sim_environment(car, self.object_mask, print_coords=True)
